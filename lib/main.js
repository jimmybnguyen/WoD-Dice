...
* @param dices: the number of dices to be added
*
*/
...
* @param dices: the number of dices to be removed
*
*/
...
/**
* Changes the rerollOn value in the pool
* @param threshold: the number reroll will be changed into
*
*/
...
/**
* 
* @return true if the number of dices is less than 1
*
*/
